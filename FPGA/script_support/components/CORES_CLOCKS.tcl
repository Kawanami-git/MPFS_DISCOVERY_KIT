# Exporting Component Description of CORES_CLOCKS to TCL
# Family: PolarFireSoC
# Part Number: MPFS095T-1FCSG325E
# Create and Configure the core component CORES_CLOCKS
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:2.2.220} -component_name {CORES_CLOCKS} -params {\
...
# Exporting Component Description of CORES_CLOCKS to TCL done
