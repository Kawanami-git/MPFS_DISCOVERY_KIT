# Exporting Component Description of DP_LSRAM_8K to TCL
# Family: PolarFireSoC
# Part Number: MPFS095T-1FCSG325E
# Create and Configure the core component DP_LSRAM_8K
create_and_configure_core -core_vlnv {Actel:SgCore:PF_DPSRAM:1.1.110} -component_name {DP_LSRAM_8K} -params {\
"A_BLK_POLARITY:2"  \
...
"RWB_PN:B_WEN"  \
"SII_LOCK:0"   }
# Exporting Component Description of DP_LSRAM_8K to TCL done
