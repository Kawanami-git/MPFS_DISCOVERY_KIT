...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS_0:FIC_0_CLK" "MSS_WRAPPER_0:FIC_0_ACLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS_0:FIC_3_CLK" "MSS_WRAPPER_0:FIC_3_PCLK" }
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS_WRAPPER_0:MSS_INT_F2M[2:2]} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS_WRAPPER_0:MSS_INT_F2M[4:4]} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {OR2_LED1:A} -value {GND}
# sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_PERIPHERALS_0:GPIO_OUT[1:1]" "OR2_LED2:A" }
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {OR2_LED2:A} -value {GND}
# sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_PERIPHERALS_0:GPIO_OUT[2:2]" "OR2_LED3:A" }
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {OR2_LED3:A} -value {GND}
# sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_PERIPHERALS_0:GPIO_OUT[3:3]" "OR2_LED4:A" }
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {OR2_LED4:A} -value {GND}
# sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_PERIPHERALS_0:GPIO_OUT[4:4]" "OR2_LED5:A" }
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {OR2_LED5:A} -value {GND}
# sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_PERIPHERALS_0:GPIO_OUT[5:5]" "OR2_LED6:A" }
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {OR2_LED6:A} -value {GND}
# sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_PERIPHERALS_0:GPIO_OUT[6:6]" "OR2_LED7:A" }
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {OR2_LED7:A} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS_WRAPPER_0:MSS_INT_F2M[63:63]} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS_WRAPPER_0:MSS_INT_F2M[62:62]} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS_WRAPPER_0:MSS_INT_F2M[61:61]} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS_WRAPPER_0:MSS_INT_F2M[60:60]} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS_WRAPPER_0:MSS_INT_F2M[59:59]} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORES_CLOCKS_0:PLL_POWERDOWN_N_0} -value {VCC}
sd_connect_pins             -sd_name ${sd_name} -pin_names {"REF_CLK_50MHz"                 "CORES_CLOCKS_0:REF_CLK_0"   }


sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS_0:FIC_0_CLK"         "AXI4_INTERCONNECT_0:ACLK"          }
...
sd_connect_pins         -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS_0:RESETN_FIC_0_CLK"  "riscv_core_harness:axi_rstn_i"    }
sd_connect_pins         -sd_name ${sd_name} -pin_names {"AXI4_INTERCONNECT_0:AXI4mslave0"       "riscv_core_harness:SYS_RESET_AXI4_TARGET" }
sd_connect_pins         -sd_name ${sd_name} -pin_names {"AXI4_INTERCONNECT_0:AXI4mslave1"       "riscv_core_harness:INSTR_AXI4_TARGET" }
sd_connect_pins         -sd_name ${sd_name} -pin_names {"AXI4_INTERCONNECT_0:AXI4mslave2"       "riscv_core_harness:DATA_AXI4_TARGET" }
sd_connect_pins         -sd_name ${sd_name} -pin_names {"AXI4_INTERCONNECT_0:AXI4mslave3"       "riscv_core_harness:PTC_AXI4_TARGET" }
sd_connect_pins         -sd_name ${sd_name} -pin_names {"AXI4_INTERCONNECT_0:AXI4mslave4"       "riscv_core_harness:CTP_AXI4_TARGET" }
sd_connect_pins         -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS_0:FIC_0_CLK"         "riscv_core_harness:axi_clk_i"     }
sd_connect_pins         -sd_name ${sd_name} -pin_names {"CORES_CLOCKS_0:OUT0_FABCLK_0"           "riscv_core_harness:core_clk_i"    }
####################################                ###################################
