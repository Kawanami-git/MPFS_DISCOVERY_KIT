...
module dpram_64w #(
  ...
  dpram_32w #(
      ...
      .a_clk_i  (a_clk_i),
      .a_addr_i (a_addr_i),
      .a_wdata_i(a_wdata_i[63:32]),
      .a_be_i   (a_be_i[7:4]),
      .a_wren_i (a_wren_i),
      .a_rden_i (a_rden_i),
      .a_rdata_o(a_rdata_o[63:32]),
      .b_clk_i  (b_clk_i),
      .b_addr_i (b_addr_i),
      .b_wdata_i(b_wdata_i[63:32]),
      .b_be_i   (b_be_i[7:4]),
      .b_wren_i (b_wren_i),
      .b_rden_i (b_rden_i),
      .b_rdata_o(b_rdata_o[63:32])
  );
  ...
  dpram_32w #(
      ...
      .a_clk_i  (a_clk_i),
      .a_addr_i (a_addr_i),
      .a_wdata_i(a_wdata_i[31:0]),
      .a_be_i   (a_be_i[3:0]),
      .a_wren_i (a_wren_i),
      .a_rden_i (a_rden_i),
      .a_rdata_o(a_rdata_o[31:0]),
      .b_clk_i  (b_clk_i),
      .b_addr_i (b_addr_i),
      .b_wdata_i(b_wdata_i[31:0]),
      .b_be_i   (b_be_i[3:0]),
      .b_wren_i (b_wren_i),
      .b_rden_i (b_rden_i),
      .b_rdata_o(b_rdata_o[31:0])
  );
  //==========================================================================
