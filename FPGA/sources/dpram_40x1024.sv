...
module dpram_40x1024 #(
  ...
  dpram_20x1024 ram_hi (
      .a_clk_i  (a_clk_i),
      .a_addr_i (a_addr_i),
      .a_wdata_i(a_wdata_i[39:20]),
      .a_be_i   (a_be_i[3:2]),
      .a_wren_i (a_wren_i),
      .a_rden_i (a_rden_i),
      .a_rdata_o(a_rdata_o[39:20]),
      .b_clk_i  (b_clk_i),
      .b_addr_i (b_addr_i),
      .b_wdata_i(b_wdata_i[39:20]),
      .b_be_i   (b_be_i[3:2]),
      .b_wren_i (b_wren_i),
      .b_rden_i (b_rden_i),
      .b_rdata_o(b_rdata_o[39:20])
  );
  ...
  dpram_20x1024 ram_lo (
      .a_clk_i  (a_clk_i),
      .a_addr_i (a_addr_i),
      .a_wdata_i(a_wdata_i[19:0]),
      .a_be_i   (a_be_i[1:0]),
      .a_wren_i (a_wren_i),
      .a_rden_i (a_rden_i),
      .a_rdata_o(a_rdata_o[19:0]),
      .b_clk_i  (b_clk_i),
      .b_addr_i (b_addr_i),
      .b_wdata_i(b_wdata_i[19:0]),
      .b_be_i   (b_be_i[1:0]),
      .b_wren_i (b_wren_i),
      .b_rden_i (b_rden_i),
      .b_rdata_o(b_rdata_o[19:0])
  );
